...
public class BookInfoPanel extends JPanel implements iGUI {
    // Mendeklarasikan variabel instance. BOOKDATAPANEL yang merupakan objek dari kelas JPanel. Panel ini digunakan untuk menampilkan seratus kata teratas beserta jumlah kemunculannya.
    private final JPanel BOOKDATAPANEL;

    // Mendeklarasikan variabel instance LINECOUNTFIELD yang merupakan objek dari kelas JLabel. Label ini akan menampilkan informasi tentang total baris dalam buku.
    private final JLabel LINECOUNTFIELD;

    // Mendeklarasikan variabel instance WORDCOUNTFIELD yang merupakan objek dari kelas JLabel. Label ini akan menampilkan informasi tentang total kata dalam buku.
    private final JLabel WORDCOUNTFIELD;

    // Mendefinisikan konstruktor untuk kelas BookInfoPanel.
    public BookInfoPanel() {
        // Mengatur layout panel menggunakan BorderLayout.
        this.setLayout(new BorderLayout());
        // Menambahkan border berjudul "Book Data" pada panel.
